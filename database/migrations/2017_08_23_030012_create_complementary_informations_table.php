...
class CreateComplementaryInformationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('complementary_informations_2_7', function (Blueprint $table) {
            ...
            $table->integer('some_family_mem_fri_said_that_are_get_forg_2_7');
            ...
            $table->integer('in_the_last_mon_were_dismayed_sad_hop_2_7');
            $table->integer('in_the_last_mon_lost_int_pleas_act_form_pleas_2_7');
            $table->timestamps();
        });
    }
