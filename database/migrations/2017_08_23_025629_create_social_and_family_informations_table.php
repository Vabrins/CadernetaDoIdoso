...
class CreateSocialAndFamilyInformationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('social_and_family_informations_1_b', function (Blueprint $table) {
            ...
            $table->boolean('you_live_long_term_inst_eld_ilpi_shelter_or_nursing_home_1_b');
            $table->boolean('in_the_last_30_days_you_have_met_friends_1_b');
            $table->boolean('in_case_of_need_you_have_some_to_acc_the_health_fac_query_1_b');
            $table->boolean('have_you_easy_access_pharmacy_services_bakery_supermarket_1_b');
