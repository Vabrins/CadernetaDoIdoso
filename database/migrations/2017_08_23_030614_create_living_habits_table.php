...
class CreateLivingHabitsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('living_habits_2_11', function (Blueprint $table) {
            ...
            $table->boolean('do_you_engage_type_ph_act_least_three_tm_week_2_11');
            $table->boolean('would_you_like_start_some_phy_activity_program_2_11');
            $table->boolean('do_you_make_at_least_three_meals_a_day_2_11');
            $table->boolean('do_you_eat_fruits_veg_your_meals_thro_the_day_2_11');
            $table->boolean('in_at_least_one_meal_day_you_eat_meat_fish_eggs_2_11');
            $table->boolean('you_have_custom_consuming_sug_dr_cak_bis_stuf_dess_2_11');
            $table->boolean('in_the_prep_your_meals_great_qt_oils_used_fats_su_salt_2_11');
