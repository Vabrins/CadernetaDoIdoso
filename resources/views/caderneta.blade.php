            ...
            return (
              <div>
                <h2>DADOS PESSOAIS</h2>
                  ...
                  <br/><br/>
                  <label>Foto:</label><br/>
                  <input type="text"  className="answers-4" id="1-photo" name="answers[1[photo]]" />
                  <br/><br/>
                  ...
                  <br/><br/>
                  <label>Data de nascimento</label><br/>
                  <input type="data" className="answers-45" id="1.1-dateofbirth" name="answers[1.1[dateofbirt]]"  />
                  <br/><br/>
                  ...
                  <input type="data" className="answers-50" id="1.1-data" name="answers[1.1[data]]"  />
                  ...
                  <br/><br/>
                  <label>Data</label><br/>
                  <input type="data" className="answers-74" id="2.4-data" name="answers[2.4[data]]"  />
                  <br/><br/>
                  ...
                  <label>Data</label><br/>
                  <input type="data" className="answers-108" id="2.10b-data" name="answers[2.10b[data]]"  /><br/>
                  <br/><br/>
                  ...
                  <label>Data</label><br/>
                  <input type="data" className="answers-129" id="2.11a-data" name="answers[2.11a[data]]"  />
                  <br/><br/>
                  ...
                  <br/><br/>
                  <label>Data</label><br/>
                  <input type="data" className="answers-135" id="2.11c-data" name="answers[2.11c[data]]"  />
                  <br/><br/>
                  <label>Lote</label><br/>
                  ...
                  <label>Data</label><br/>
                  <input type="data" className="answers-172" id="2.11e-data" name="answers[2.11e[data]]"  />
                  <br/><br/>
                  <label>Hora</label><br/>
